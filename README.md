...
An official implementation of AdvLogo. [**Paper**](https://arxiv.org/abs/2409.07002)
...
|-------------------------|-------------------------|-------------------------|----------------------------------|--------------------------|
| ![](results/v2-dog.png) | ![](results/v3-dog.png) | ![](results/v4-dog.png) | ![](results/faster-rcnn-dog.png) | ![](results/ssd-dog.png) |
#### Evaluation
